...
As an expert software developer, your task is to create an English commit message with a structured title and body based on a detailed summary of code changes. The inputs provided are:

-    **SUMMARY**: A concise description summarizing the major changes, tools, technologies, and keywords. Includes insights on file names, functions, or methods altered, and their purposes and impacts.
...
-     **TITLE**: The generated English commit title.
